...
VALUES
    (2000000, 'Brainstorming Session', 'Need help with creative ideas for a project', 100000, 1000004, 'Accepted' ),
    (2000001, 'Resume Review', 'Looking for feedback and suggestions on my resume', 100000, 1000006, 'Pending'),
    (2000002, 'Study Plan Assistance', 'Need guidance in creating an effective study plan', 100000, 1000034, 'Accepted'),
    ...
    (2000006, 'Presentation Practice', 'Seeking assistance in improving my presentation skills', 100001, 1000011, 'Pending'),
    ...
    (2000011, 'Essay Proofreading', 'Need proofreading and editing for my essay', 100000, 1000003, 'Pending'),
    (2000012, 'Course Selection Advice', 'Seeking recommendations for course selection', 100001, 1000004, 'Accepted'),
    (2000013, 'Exam Preparation Tips', 'Looking for tips and strategies to excel in exams', 100001, 1000005, 'Pending'),
    (2000014, 'Homework Help', 'Need assistance with homework assignments', 100001, 1000009, 'Pending'),
    ...
    (2000017, 'Cover Letter Writing', 'Looking for assistance in writing a compelling cover letter', 100002, 1000037, 'Pending'),
    (2000018, 'Exam Study Group', 'Forming a study group for exam preparation', 100001, 1000038, 'Accepted'),
    ...
    (2000021, 'Thesis Proposal Review', 'Looking for feedback on my thesis proposal', 100001, 1000031, 'Pending'),
    ...
    (2000026, 'Presentation Feedback', 'Seeking feedback on my presentation delivery', 100001, 1000048, 'Accepted'),
    (2000027, 'Language Learning Advice', 'Looking for tips and resources to improve language skills', 100000, 1000039, 'Pending'),
    ...
    (2000032, 'Research Proposal Review', 'Seeking feedback on my research proposal', 100001, 1000046, 'Accepted'),
    (2000033, 'Career Development Workshop', 'Interested in attending a career development workshop', 100001, 1000015, 'Pending'),
    (2000034, 'Academic Advising', 'Need advice on course selection and academic planning', 100001, 1000028, 'Accepted'),
    (2000035, 'Job Interview Coaching', 'Looking for coaching and practice for job interviews', 100001, 1000015, 'Pending'),
    (2000036, 'Graduate School Application Help', 'Need assistance with graduate school applications', 100000, 1000020, 'Accepted'),
    (2000037, 'Portfolio Review', 'Seeking feedback on my portfolio for creative work', 100001, 1000030, 'Pending'),
    (2000038, 'Entrepreneurship Advice', 'Looking for advice and guidance on starting a business', 100001, 1000040, 'Accepted'),
    ...
    (2000042, 'Study Space Recommendations', 'Looking for recommendations for quiet study spaces', 100000, 1000032, 'Accepted'),
    (2000043, 'Career Fair Preparation', 'Need guidance on preparing for career fairs', 100001, 1000043, 'Pending'),
    (2000044, 'Graduation Requirements Review', 'Seeking clarification on graduation requirements', 100000, 1000036, 'Accepted'),
    ...
    (2000047, 'Course Recommendation', 'Need recommendations for elective courses', 100001, 1000047, 'Pending'),
    (2000048, 'Research Assistance', 'Looking for assistance in conducting research', 100001, 1000045, 'Accepted'),
    (2000049, 'Exam Proctoring', 'Need a proctor for an upcoming exam', 100001, 1000041, 'Pending');
